...
Hi {user.first_name}! Click Search Number button and send your desire number to get information.

**Example:** `1712345678`

**Commands:**
/start - Restart bot anytime
...
20 Credits = 50 tk (20 days)
50 Credits = 100 tk (30 days)
Unlimited Credit = 250 tk (30 days)
"""
